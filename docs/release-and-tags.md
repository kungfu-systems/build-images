...
|---|---|---|---|---|---|---|
| 2026-07-25 | add | v1.3 | image-family, image-contracts | additive minor | Add the consumer-neutral `demo-renderer` image with a digest-pinned browser/media/font toolchain and deterministic transcript-bound output contract. | #318 |
