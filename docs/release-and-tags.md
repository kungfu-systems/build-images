...
|---|---|---|---|---|---|---|
| 2026-07-31 | extend | v1.3 | image-contracts | additive minor | Extend `demo-renderer` with source-resolution MP4/WebM plus deterministic 1280x720 MP4/WebM/GIF renditions encoded from one frame set, preserving one capture and renderer authority chain. | pending |
